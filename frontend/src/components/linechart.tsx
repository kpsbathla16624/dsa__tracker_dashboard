...
const CodechefRatingGraph: React.FC<CodechefRatingGraphProps> = ({ ratingData }) => {
  ...
  return (
    <div className="w-[700px] h-[300px]  justify-center items-center flex flex-col my-2 p-4 border rounded-lg shadow-lg backdrop-blur-lg bg-opacity-75 bg-gradient-to-br from-gray-800 via-black to-gray-800 bg-blur-xl">
